...
class DatabaseConn {	
  ...
  public function dbOpen(){
    ...
    try {
      ...
      $dbHost = 'localhost';
      $dbName = 'ccratcliff';//this will be your WCC username
      $dbUsr = 'ccratcliff';//this will be your WCC username
      $dbPass = 'RYdK3HgEejjz';//this will be the password found in the video.
